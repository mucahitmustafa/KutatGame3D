...
var AvailableAreas = [Vector3(8, 0.05, 0), Vector3(16, 0.05, 0), Vector3(24, 0.05, 0), Vector3(8, 0.05, -8), Vector3(16, 0.05, -8), Vector3(24, 0.05, -8), Vector3(8, 0.05, -16), Vector3(16, 0.05, -16), Vector3(24, 0.05, -16)];
